...
VALUES ($1, $2, $3, $4) RETURNING id, order_id, product_id, quantity, price_cent
`
...
type CreateOrderItemParams struct {
	...
	PriceCent int32 `json:"price_cent"`
}
...
SELECT id, name, price_in_cent, quantity, created_at FROM products WHERE id = $1
`
...
SELECT id, name, price_in_cent, quantity, created_at FROM products
`
